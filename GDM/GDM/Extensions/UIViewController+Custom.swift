...
extension UIViewController {
        func showToast(message: String) {
            ...
            let containerTrailing = NSLayoutConstraint(item: toastLabel, attribute: .width, relatedBy: .equal, toItem: toastContainer, attribute: .width, multiplier: 0.9, constant: 0)
            ...
            let containerWidth = NSLayoutConstraint(item: toastContainer, attribute: .width, relatedBy: .equal, toItem: self.view, attribute: .width, multiplier: 0.9, constant: 0)
            self.view.addConstraints([containerCenterX, containerTrailing, containerBottom, containerWidth])
